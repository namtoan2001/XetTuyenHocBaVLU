    ...
    <div style={{ backgroundColor: "#eff3f8" }}>
      ...
      <Routes>
        ...
        <Route
          ...
          path="/suahoso"
          element={
            <Edit setDataEdit={setDataEdit} setIsLoading={setIsLoading} />
          }
        />
        <Route
          exact
          ...
          element={
            Object.keys(dataEdit).length === 0 ? (
              ...
              <PreviewEdit dataEdit={dataEdit} setIsLoading={setIsLoading} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            role === "Admin" ? (
              <AccountCreate setIsLoading={setIsLoading} />
            ) : (
              <Forbidden />
            )
          }
        ...
        <Route
          ...
          element={
            role === "Admin" ? (
              <AccountEdit setIsLoading={setIsLoading} />
            ) : (
              <Forbidden />
            )
          }
        ...
        <Route
          ...
          element={
            role === "Admin" ? (
              <Phase setIsLoading={setIsLoading} />
            ) : (
              <Forbidden />
            )
          }
        ...
        <Route
          ...
          element={
            role === "Admin" ? (
              <Notification setIsLoading={setIsLoading} />
            ) : (
              <Forbidden />
            )
          }
        ...
        <Route
          ...
          element={
            role === "Admin" ? (
              <Schedule setIsLoading={setIsLoading} />
            ) : (
              <Forbidden />
            )
          }
