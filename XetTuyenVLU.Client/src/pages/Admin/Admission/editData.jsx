    ...
    <Container className={classes.container}>
      ...
      {openModal ? (
        <PreviewMailBeforeSendModal
          ...
          handleGetAdmission={handleGetAdmission}
        />
      ) : (
        ""
      )}
            ...
            >
              ...
              <span
                style={{
                  fontWeight: "bold",
                  paddingLeft: "7px",
                  color: admission.daNhanHoSo === "N" ? "green" : "red",
                }}
              >
                {admission.daNhanHoSo === "N" ? "ĐÃ NHẬN" : "CHƯA"}
              </span>
            </div>
            <div
              style={{
            ...
            >
              ...
              <span
                style={{
                  fontWeight: "bold",
                  paddingLeft: "7px",
                  color: admission.daGuiMail ? "green" : "red",
                }}
              >
                {admission.daGuiMail ? "ĐÃ GỬI" : "CHƯA GỬI"}
              </span>
            </div>
          </div>
        </div>
