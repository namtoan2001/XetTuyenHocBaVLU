      ...
      .then((response) => {
        var list = response.data.map((data) => {
          return {
            ...
            khoa: null,
            phase: data.phase,
            daGuiMail: data.daGuiMail === true ? "Đã gửi" : "Chưa gửi"
          };
        });
        setDataForHoso(list);
  ...
  const handleOnExport = () => {
    ...
    const HeaderBangDiem =[
      [
        "ID",
        "HỌ VÀ TÊN",
        "ĐIỂM TOÁN CẢ NĂM LỚP 11",
        "ĐIỂM VĂN CẢ NĂM LỚP 11",
        "ĐIỂM ANH CẢ NĂM LỚP 11",
        "ĐIỂM PHÁP CẢ NĂM LỚP 11",
        "ĐIỂM LÝ CẢ NĂM LỚP 11",
        "ĐIỂM HÓA CẢ NĂM LỚP 11",
        "ĐIỂM SINH CẢ NĂM LỚP 11",
        "ĐIỂM SỬ CẢ NĂM LỚP 11",
        "ĐIỂM ĐỊA CẢ NĂM LỚP 11",
        "ĐIỂM GDCD CẢ NĂM LỚP 11",
        "ĐIỂM TOÁN HỌC KÌ I LỚP 12",
        "ĐIỂM VĂN HỌC KÌ I LỚP 12",
        "ĐIỂM ANH HỌC KÌ I LỚP 12",
        "ĐIỂM PHÁP HỌC KÌ I LỚP 12",
        "ĐIỂM LÝ HỌC KÌ I LỚP 12",
        "ĐIỂM HÓA HỌC KÌ I LỚP 12",
        "ĐIỂM SINH HỌC KÌ I LỚP 12",
        "ĐIỂM SỬ HỌC KÌ I LỚP 12",
        "ĐIỂM ĐỊA HỌC KÌ I LỚP 12",
        "ĐIỂM GDCD HỌC KÌ I LỚP 12",
        "ĐIỂM TOÁN CẢ NĂM LỚP 12",
        "ĐIỂM VĂN CẢ NĂM LỚP 12",
        "ĐIỂM ANH CẢ NĂM LỚP 12",
        "ĐIỂM PHÁP CẢ NĂM LỚP 12",
        "ĐIỂM LÝ CẢ NĂM LỚP 12",
        "ĐIỂM HÓA CẢ NĂM LỚP 12",
        "ĐIỂM SINH CẢ NĂM LỚP 12",
        "ĐIỂM SỬ CẢ NĂM LỚP 12",
        "ĐIỂM ĐỊA CẢ NĂM LỚP 12",
        "ĐIỂM GDCD CẢ NĂM LỚP 12",
      ]
    ]
    var wscols = [
      { width: 7 },
      ...
      RejectAdmissionProfileById(id)
        .then((response) => {
          if (response.data) {
            setTimeout(() => {
              props.setIsLoading(false);
              toast.success(`Từ chối nhận hồ sơ xét tuyển thành công!`, {
                theme: "colored",
              });
            }, 1000);
            fetchDataAdmission();
